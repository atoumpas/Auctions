 ...
 * @author Axilleas
 */
public class VickreyAuctioneerBehaviour extends SimpleBehaviour  {
    ...
    private void announceWinner() {
        ...
        for (ACLMessage bid : bids.values()) {
            if (bid == winnerBid) {
                ...
                String content = "Item has been sold to " + bid.getSender().getLocalName() + " for " + secondHighestBid;
